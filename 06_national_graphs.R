...
msni19::sunburst_msni(df, 
                      ...
                      print_plot = T,
                      plot_name = paste0("national_", "page1_full_sunburst"),
                      path = "output/graphs/national/national/")
...
msni19::index_chart(df,
                    ...
                    bar_graph = F,
                    print_plot = T,
                    plot_name = paste0("national_","page2_msni_line"),
                    path = "output/graphs/national/")
...
msni19::index_chart(df,
                    ...
                    bar_graph = T,
                    print_plot = T,
                    plot_name = paste0("national_", "page2_msni_bar"),
                    path = "output/graphs/national/")



# sunburst page 2 group A : 
msni19::sunburst_msni(dplyr::filter(df, idp_settlement == "yes"),
                      msni = "msni", fsl_lsg = "fsl_score", health_lsg = "health_score", 
                      protection_lsg = "prot_score", shelter_lsg = "snfi_score",
                      wash_lsg = "wash_score", capacity_gaps = "mcsi_score", impact = "impact_score", 
                      fsl_wash_branch = T,
                      weighting_function = weighting_function,
                      print_plot = T,
                      plot_name = paste0("national_", "page2_full_sunburst_A_idp"),
                      path = "output/graphs/national/")

# sunburst page 2 group B :
msni19::sunburst_msni(dplyr::filter(df, idp_settlement == "no"),
                      msni = "msni", fsl_lsg = "fsl_score", health_lsg = "health_score", 
                      protection_lsg = "prot_score", shelter_lsg = "snfi_score",
                      wash_lsg = "wash_score", capacity_gaps = "mcsi_score", impact = "impact_score", 
                      fsl_wash_branch = T,
                      weighting_function = weighting_function,
                      print_plot = T,
                      plot_name = paste0("national_", "page2_full_sunburst_B_hc"),
                      path = "output/graphs/national/")
...
mapply(make_bar_line_graph, page = simple_chart_and_page$page, lsg_to_graph = simple_chart_and_page$lsg, 
       MoreArgs = list(df = df, region = "national_"))
...
msni19::radar_graph(df, 
                    ...
                    weighting_function = weighting_function,
                    print_plot = T,
                    plot_name = paste0("national_", "page11_radar"),
...
msni19::severity_lines(df,
                       ...
                       weighting_function = weighting_function,
                       print_plot = T,
                       plot_name = paste0("national_", "page11_over3"),
                       path = "output/graphs/national/")
...
msni19::venn_msni(df,
                  ...
                  weighting_function = weighting_function,
                  print_plot = T,
                  plot_name = paste0("national_", "page11_venn"),
                  path = "output/graphs/national/")
...
msni19::index_intersections(df,
                            ...
                            weighting_function = weighting_function,
                            print_plot = T,
                            plot_name = paste0("national_","page11_intersection"),
                            path = "output/graphs/national/")
